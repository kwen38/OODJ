...
public class PeopleBookVaccinationAppointmentController implements Initializable {
        
    @FXML
    private AnchorPane PeopleBookVaccinationAppointment;
    @FXML
    ...
    public void refresh(){
        txtICAddAppoinment.setText("");
         try {
            ...
            primaryStage.show();
            PeopleBookVaccinationAppointment.getScene().getWindow().hide();
	}
	catch (Exception e) {
